 ...
 */
final class Version20220620114736 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE race_source_pouvoir (race_id INT NOT NULL, source_pouvoir_id INT NOT NULL, INDEX IDX_4186C4C46E59D40D (race_id), INDEX IDX_4186C4C4B41374DC (source_pouvoir_id), PRIMARY KEY(race_id, source_pouvoir_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE race_source_pouvoir ADD CONSTRAINT FK_4186C4C46E59D40D FOREIGN KEY (race_id) REFERENCES race (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE race_source_pouvoir ADD CONSTRAINT FK_4186C4C4B41374DC FOREIGN KEY (source_pouvoir_id) REFERENCES source_pouvoir (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE source_pouvoir DROP FOREIGN KEY FK_F7A0D6AE6E59D40D');
        $this->addSql('DROP INDEX IDX_F7A0D6AE6E59D40D ON source_pouvoir');
        $this->addSql('ALTER TABLE source_pouvoir DROP race_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE race_source_pouvoir');
        ...
        $this->addSql('ALTER TABLE source_pouvoir ADD race_id INT DEFAULT NULL, CHANGE nom_source nom_source VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE caracteristique caracteristique LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE src src VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE source_pouvoir ADD CONSTRAINT FK_F7A0D6AE6E59D40D FOREIGN KEY (race_id) REFERENCES race (id)');
        $this->addSql('CREATE INDEX IDX_F7A0D6AE6E59D40D ON source_pouvoir (race_id)');
