 ...
 */
final class Version20220620083431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE source_pouvoir (id INT AUTO_INCREMENT NOT NULL, race_id INT DEFAULT NULL, nom_source VARCHAR(255) NOT NULL, caracteristique LONGTEXT NOT NULL, src VARCHAR(255) NOT NULL, INDEX IDX_F7A0D6AE6E59D40D (race_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE source_pouvoir');
