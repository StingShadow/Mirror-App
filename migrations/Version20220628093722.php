 ...
 */
final class Version20220628093722 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message DROP created_at, CHANGE message message LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
