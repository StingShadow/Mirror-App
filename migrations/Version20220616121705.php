 ...
 */
final class Version20220616121705 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fiche_personnage CHANGE `force` force_personnage INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE race CHANGE nomrace nomrace VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE descriptionrace descriptionrace LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE capaciterace capaciterace LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
